...
GLM_FUNC_QUALIFIER glm_vec4 glm_vec4_clamp(glm_vec4 v, glm_vec4 minVal,
                                           glm_vec4 maxVal) {
...
GLM_FUNC_QUALIFIER glm_vec4 glm_vec4_smoothstep(glm_vec4 edge0, glm_vec4 edge1,
                                                glm_vec4 x) {
  glm_vec4 const sub0 = glm_vec4_sub(x, edge0);
  glm_vec4 const sub1 = glm_vec4_sub(edge1, edge0);
  glm_vec4 const div0 = glm_vec4_sub(sub0, sub1);
  glm_vec4 const clp0 =
      glm_vec4_clamp(div0, _mm_setzero_ps(), _mm_set1_ps(1.0f));
...
GLM_FUNC_QUALIFIER glm_vec4 glm_vec4_nan(glm_vec4 x) {
  ...
  glm_ivec4 const t2 =
      _mm_sll_epi32(t1, _mm_cvtsi32_si128(1));          // shift out sign bit
...
GLM_FUNC_QUALIFIER glm_vec4 glm_vec4_inf(glm_vec4 x) {
  ...
  glm_ivec4 const t2 =
      _mm_sll_epi32(t1, _mm_cvtsi32_si128(1)); // shift out sign bit
  return _mm_castsi128_ps(_mm_cmpeq_epi32(
      t2,
      _mm_set1_epi32(int(0xFF000000)))); // exponent is all 1s, fraction is 0
}
