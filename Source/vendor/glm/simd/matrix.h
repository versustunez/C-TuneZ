...
GLM_FUNC_QUALIFIER void glm_mat4_matrixCompMult(glm_vec4 const in1[4],
                                                glm_vec4 const in2[4],
                                                glm_vec4 out[4]) {
...
GLM_FUNC_QUALIFIER void glm_mat4_add(glm_vec4 const in1[4],
                                     glm_vec4 const in2[4], glm_vec4 out[4]) {
...
GLM_FUNC_QUALIFIER void glm_mat4_sub(glm_vec4 const in1[4],
                                     glm_vec4 const in2[4], glm_vec4 out[4]) {
...
GLM_FUNC_QUALIFIER void glm_mat4_mul(glm_vec4 const in1[4],
                                     glm_vec4 const in2[4], glm_vec4 out[4]) {
  {
...
GLM_FUNC_QUALIFIER void glm_mat4_transpose(glm_vec4 const in[4],
                                           glm_vec4 out[4]) {
...
GLM_FUNC_QUALIFIER void glm_mat4_inverse(glm_vec4 const in[4],
                                         glm_vec4 out[4]) {
  __m128 Fac0;
  {
    //	valType SubFactor00 = m[2][2] * m[3][3] - m[3][2] * m[2][3];
...
GLM_FUNC_QUALIFIER void glm_mat4_inverse_lowp(glm_vec4 const in[4],
                                              glm_vec4 out[4]) {
  __m128 Fac0;
  {
    //	valType SubFactor00 = m[2][2] * m[3][3] - m[3][2] * m[2][3];
...
*/
GLM_FUNC_QUALIFIER void glm_mat4_outerProduct(__m128 const &c, __m128 const &r,
                                              __m128 out[4]) {
